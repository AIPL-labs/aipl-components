import { AiFunctionCall, AppMessage, AppMessageMap, DataObject } from 'ai-worker-common';
...
export declare const EVENTS: EventEmitter<AiplClientEventMap>;
//# sourceMappingURL=AiplClientEvents.d.ts.map